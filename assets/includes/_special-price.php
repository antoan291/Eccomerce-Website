...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    if(isset($_POST['special_price_button'])){
...
<section id="special-price">
    <div class="container">
        <h4 class="font-sans font-size-20">Special Price</h4>
        <div id="filters" class="button-group text-end font-fredoka font-size-16">
